        ...
        <AnimatePresence>
          {hovered && (
            <motion.div
              ...
              className="absolute -top-8 left-1/2 w-fit rounded-md border border-gray-200 px-2 py-0.5 text-xs whitespace-pre dark:border-neutral-900 bg-neutral-800 text-white"
            >
              {title}
            </motion.div>
          )}
